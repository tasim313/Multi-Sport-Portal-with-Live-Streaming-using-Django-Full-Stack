...
class ScoreEvent(models.Model):
    ...
    period = models.CharField(max_length=50, blank=True)  # "1st Half", "Over 15", etc.
...
class AdPlacement(models.Model):
    ...
    slot_key = models.CharField(max_length=100, unique=True)  # "header_banner", "sidebar_ad"
    label = models.CharField(max_length=200)
    device_target = models.CharField(max_length=20, choices=DEVICE_CHOICES, default='all')
    path_pattern = models.CharField(max_length=200, default='*')  # URL pattern to match
    is_active = models.BooleanField(default=True)
...
class AdCreative(models.Model):
    ...
    name = models.CharField(max_length=200)
    html_snippet = models.TextField()  # HTML/JS ad code
    
    start_at = models.DateTimeField(default=timezone.now)
    end_at = models.DateTimeField(null=True, blank=True)
    
    # Capping rules as JSON: {"daily_impressions": 1000, "frequency_cap": 3}
...
class AuditLog(models.Model):
    ...
    action = models.CharField(max_length=100)  # "create_stream", "update_match"
